...
cross-compile:
	mkdir -p bin
	GOOS=darwin GOARCH=amd64 go build -o bin/ddev-darwin-amd64 ddev/main/ddev.go
	GOOS=darwin GOARCH=arm64 go build -o bin/ddev-darwin-arm64 ddev/main/ddev.go
	GOOS=linux GOARCH=amd64 go build -o bin/ddev-linux-amd64 ddev/main/ddev.go
	GOOS=linux GOARCH=arm64 go build -o bin/ddev-linux-arm64 ddev/main/ddev.go
	GOOS=windows GOARCH=amd64 go build -o bin/ddev-windows-amd64.exe ddev/main/ddev.go
	GOOS=windows GOARCH=arm64 go build -o bin/ddev-windows-arm64.exe ddev/main/ddev.go
